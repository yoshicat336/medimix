                ...
                <CardContent className="py-6 space-y-4">
                  ...
                  <div className="flex justify-center">
                    <Button
                      ...
                      className="bg-[#e0e5ec] text-medical hover:bg-[#e8edf4] shadow-[-3px_-3px_6px_rgba(255,255,255,0.8),3px_3px_6px rgba(0,0,0,0.1)] hover:shadow-[-4px_-4px_8px_rgba(255,255,255,0.9),4px_4px_8px_rgba(0,0,0,0.15)] transition-all duration-300"
                    >
                      Suggest Definition
                    </Button>
                  </div>
